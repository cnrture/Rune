...
import com.github.teknasyon.getcontactdevtools.common.file.ImportAnalyzer
...
object Utils {
            ...
            if (settingsGradleFile != null) {
                ...
                val filesCreated = fileWriter.createModule(
                    ...
                    showSuccessDialog = {
                        ...
                        ApplicationManager.getApplication().invokeLater {
                            ToolWindowManager.getInstance(project).getToolWindow("GTCDevTools")?.hide()
                        }
                    },
    ...
    fun showInfo(title: String? = null, message: String, type: NotificationType = NotificationType.INFORMATION) {
        val notification = NotificationGroupManager.getInstance()
            .getNotificationGroup("GTC Notification Group")
            .createNotification(
                title = title ?: "GTC DevTools",
                content = message,
                type = type,
            )
